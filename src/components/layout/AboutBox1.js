    ...
    <>
      <div className={styles.hero}>
        ...
        <div className={styles.content}>
          ...
          <a href="https://drive.google.com/file/d/13pNzK1RfWH5uAaSOTKBCj2wVnZdz1Mae/view?usp=sharing" target="_blank" rel="noreferrer"><button className={styles.resumeButton}>Resume</button></a>
        </div>
      </div>
    </>
  )
